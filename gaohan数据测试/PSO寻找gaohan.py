...
import linSVR
import linTools
from linData import dataHandle
...
zu.set_size(70)  # 数据总量
zu.set_numNeed(15)  # 当mode = 1 时，需要的测试集数量
...
class PSO:
    ...
    def iterator(self, bd_low, bd_up, v_low, v_up):
        ...
        for t in range(self.max_iter):
            ...
            # self.w = 0.5
            self.w = w_max - (w_max - w_min) * (t / self.max_iter) ** 2  # 更新惯性权重  随迭代次数的增大，X的变化减小
...
if __name__ == '__main__':
    #            C,    q,     t,   gamma, coef0
    bd_low1 = [  0,     0,    0,    0,    0  ]
    bd_up1  = [200,   1.0,  1.0,    4,    1  ]
    v_low1  = [  0,     0,    0,    0,    0  ]
    v_up1   = [  1,   0.5,  0.5,  1.0,   1.0 ]
    ...
    t = np.array([t for t in range(0, iter1)])
