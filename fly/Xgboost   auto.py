...
param_test1 = {
      ...
      'gamma':np.logspace(-4,4,40),

      'learning_rate':np.linspace(0.01,2.0,100)
    }
# sklearn  网格法调参
...
# # ----------------------------------------------------不用网格法调参
#
# xgb = XGBRegressor(max_depth=6, learning_rate=0.9, n_estimators=2000,gamma=0.08,min_child_weight=2)
# xgb.fit(X,y)
